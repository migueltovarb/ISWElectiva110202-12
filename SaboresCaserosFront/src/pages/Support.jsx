    ...
    return (
        ...
        {showForm && (
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                <label className="block text-morado-700 mb-2">Asunto</label>
                <input
            ...
            <div key={ticket.id} className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="border-t pt-4">
                    ...
                    {ticket.mensajes.map((mensaje) => (
                        <div key={mensaje.id} className={`p-3 rounded-lg ${
                        mensaje.usuario === ticket.usuario ? 'bg-morado-100' : 'bg-gray-100'
                        }`}>
