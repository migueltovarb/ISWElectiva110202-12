    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg max-w-md w-full p-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            <label htmlFor="tipo" className="block text-morado-700 mb-2">
              Tipo de Pago
            </label>
            <select
              id="tipo"
          ...
          <div>
            <label htmlFor="nombre_titular" className="block text-morado-700 mb-2">
              Nombre del Titular
            </label>
            <input
              id="nombre_titular"
          ...
          <div>
            <label htmlFor="numero_tarjeta" className="block text-morado-700 mb-2">
              Número de Tarjeta
            </label>
            <input
              id="numero_tarjeta"
            ...
            {errors.numero_tarjeta && (
              <p className="text-red-500 text-sm mt-1">
                {errors.numero_tarjeta.message}
              </p>
            )}
          </div>

          <div>
            <label htmlFor="fecha_expiracion" className="block text-morado-700 mb-2">
              Fecha de Expiración
            </label>
            <input
              id="fecha_expiracion"
          ...
          <div>
            <label htmlFor="es_predeterminado" className="flex items-center gap-2">
              <input
