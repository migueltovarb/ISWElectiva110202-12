...
const PlatilloModal = ({ platillo, categorias, onClose, onSave }) => {
    ...
    const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm({
        ...
        tiempo_preparacion: '',
        disponible: true,
        chef: user?.id  // Por defecto el usuario actual si es chef
        }
    });
    
    // Cargar la lista de chefs
    useEffect(() => {
    ...
    return (
        ...
        <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <div>
                <label className="block text-morado-700 mb-2">Descripción</label>
                <textarea
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                <label className="block text-morado-700 mb-2">Precio</label>
                <input
                    type="number"
                    step="0.01"
                ...
                <div>
                <label className="block text-morado-700 mb-2">Tiempo (min)</label>
                <input
                    type="number"
            ...
            <div>
                <label className="block text-morado-700 mb-2">Chef</label>
                <select
            ...
            <div>
                <label className="block text-morado-700 mb-2">Categoría</label>
                <select
            ...
            <div>
                <label className="block text-morado-700 mb-2">Imagen</label>
                <input
                type="file"
                accept="image/*"
